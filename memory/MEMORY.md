...
- [Shared layer](shared-layer.md) — cross-cutting pieces from the interviews and the directory decomposition (built: rules, board incl. MoveLine, engine, play, positions incl. recipes, facts, import, review; reserved names for the rest); tooling decisions of 2026-09-16 and why
