...
- [Lesson Builder](subprojects/lesson-builder.md) — GUI to author lessons (positions + prose + arrows + move-challenges) with no code, browser-saved + JSON export; built 2026-09-18 on packages/lessons + board shapes API
- [Interview-vs-built audit](../docs/audits/2026-09-17-interview-vs-slices.md) — 2026-09-17: per subproject, what was cut on record, what was cut with no record, and what the agents assumed; the unrecorded lists are open items for the user
...
- [Deployment](deployment.md) — 2026-09-18: GitHub Pages under nkohen.github.io/human-chess/ via `HC_SOURCE_URL=… npx pnpm@10 deploy-web` (scripts/deploy-web.sh); relative base + document-relative engine URL; live since 2026-09-18, source public at github.com/nkohen/human-chess (origin); push master before deploying
