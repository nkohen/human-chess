...
- [Shared layer](shared-layer.md) — cross-cutting pieces from the interviews and the directory decomposition (built: rules, board, engine, play, positions; reserved names for the rest); tooling decisions of 2026-09-16 and why
...
- [Minimal slices](minimal-slices.md) — user direction 2026-09-16: a super-minimal version of every subproject first, for early feedback; the table says what each slice is, what it forces, and the order
