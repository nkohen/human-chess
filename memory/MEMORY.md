...
- [Deployment](deployment.md) — 2026-09-18: GitHub Pages under nkohen.github.io/human-chess/ via `HC_SOURCE_URL=… npx pnpm@10 deploy` (scripts/deploy-web.sh); relative base + document-relative engine URL; publishing needs a public source URL (AGPL/GPL source offer)
