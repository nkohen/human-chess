...
// public folder so it can be loaded as a Web Worker at /engine/<file>. The wasm must sit next
// to its loader script under the same name, which is why it is not imported through Vite.
